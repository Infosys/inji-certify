...
VALUES (
    ...
    '{
         ...
         "credentialSubject": {
             "NumeroDeRegistroCAR": "${car_registration_number}",
             "DataDeRegistro": "${registration_date}",
             "DataDaUltimaAlteracao": "${date_of_last_amendment}",
             "AreaDaPropriedadeRural": ${rural_property_area},
             "Latitude": "${latitude}",
             "Longitude": "${longitude}",
             "Municipio": "${municipality}",
             "CondicaoExterna": "${external_condition}",
             "StatusDeRegistro": "${registration_status}",
             "CondicaoDoPRA": "${pra_condition}",
             "CoberturaDoSolo": "${land_cover}",
             "AreaDeRemanescenteDeVegetacaoNativa": ${native_vegetation_remnant_area},
             "AreaRuralConsolidada": ${consolidated_rural_area},
             "AreaDeServidaoAdministrativa": ${administrative_easement_area},
             "LocalizacaoDaReservaLegal": "${location_of_legal_reserve}",
             "AreaDeReservaLegalRegistrada": ${registered_legal_reserve_area},
             "AreaGeorreferenciadaDaReservaLegal": ${georeferenced_legal_reserve_area},
             "AreaAprovadaDaReservaLegalNaoRegistrada": ${approved_legal_reserve_area_not_registered},
             "AreaPropostaDeReservaLegal": ${proposed_legal_reserve_area},
             "TotalDeReservaLegalDeclarada": ${total_legal_reserve_declared},
             "AreasDePreservacaoPermanenteAPP": ${permanent_preservation_areas_app},
             "APPNaAreaRuralConsolidada": ${app_in_consolidated_rural_area},
             "APPNaAreaDeRemanescenteDeVegetacaoNativa": ${app_in_native_vegetation_remnant_area},
             "AreasDeUsoRestrito": ${restricted_use_areas},
             "DeficitOuExcessoDeReservaLegal": ${legal_reserve_deficit_excess},
             "AreaDeReservaLegalParaRecomposicao": ${legal_reserve_area_to_recompose},
             "AreasDePreservacaoPermanenteParaRecomposicao": ${permanent_preservation_areas_to_recompose},
             "AreaDeUsoRestritoParaRecomposicao": ${restricted_use_area_to_recompose},
             "DescricaoDaAreaEmbargada": "${embargoed_area_description}",
             "DataDeProcessamentoDaAreaEmbargada": "${embargoed_area_processing_date}",
             "SobreposicaoDaAreaEmbargada": ${embargoed_area_overlap},
             "PorcentagemDeSobreposicaoDaAreaEmbargada": ${embargoed_area_overlap_percentage},
             "DescricaoDaUnidadeDeConservacao": "${conservation_unit_description}",
             "DataDeProcessamentoDaUnidadeDeConservacao": "${conservation_unit_processing_date}",
             "AreaDeSobreposicaoDaUnidadeDeConservacao": ${conservation_unit_overlap_area},
             "PorcentagemDeSobreposicaoDaUnidadeDeConservacao": ${conservation_unit_overlap_percentage}
         }
     }
', '2024-10-24 12:32:38.065994', NULL);
...
VALUES
    ('1234567','GO-5220009-75F5.A618.6575.4003.BC3B.3901.93D4.E5C0',
     ...
     '2024-10-25',
     1167.1764, 100.0),
    ('668765133','GO-5220010-85F6.B619.7576.5004.CD4C.4902.04D5.F6D1',
     '2024-10-26 14:30:45',
     '2024-10-26',
     892.5632,
     '15°11''14.36\" S',
     ...
     '2024-10-26',
     892.5632, 100.0),
    ('6806436991','GO-5220011-95F7.C620.8577.6005.DE5D.5903.15E6.G7E2',
     '2024-10-27 09:15:22',
     '2024-10-27',
     1546.2981,
     '16°12''15.47\" S',
     ...
     '2024-10-27',
     1546.2981, 100.0),
     ('898757967','GO-5220009-12A3.B456.7890.1234.DEF5.6789.0123.ABCD',
      '2024-10-25 16:40:31',
      '2024-10-25',
      856.4321,
      '15°45''23.12\" S',
      ...
      ('4567538771','GO-5220009-12A3.B456.7890.1234.DEF5.6789.0123.ABCD',
       ...
       '2024-10-25',
       856.4321, 100.0),
       ('5614273165', 'MT-3310008-A4F6.B729.8615.5114.CD4C.4012.04D5.F6D1',
        '2024-11-16 14:22:33',
        '2024-11-20',
        2345.6789,
        '11°51''36.82\" S',
        ...
        '2024-11-20',
        234.5678, 10.0),
       ('8793000318', 'RS-4420223-C7H8.D042.1948.8357.FG7F.7345.38G8.J9K2',
        '2024-12-07 19:45:22',
        '2024-12-10',
        1523.6789,
        '29°41''33.76\" S',
